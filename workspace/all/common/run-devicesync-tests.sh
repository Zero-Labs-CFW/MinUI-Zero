...
mk "$C9" "Saves/.stfolder/syncthing-folder-9525ed.txt" "SYNCTHING"   # inside a hidden folder: never manifested
mk "$C9" ".userdata/shared/GBC-gambatte/Zelda.cfg" "CFG"               # the hidden scope ROOT itself still walks
...
nohas "syncthing-folder" "$(cat "$MF9")"
has   ".userdata/shared/GBC-gambatte/Zelda.cfg" "$(cat "$MF9")"
